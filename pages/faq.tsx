          ...
          <Accordion allowMultiple defaultIndex={[...Array(NUM_FAQS).keys()]}>
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                ...
                workers and family members to business owners and physicians — to easily and safely
                share their stories so that they can be seen by decision-makers, media and the
                public to drive effective government policy that will save lives.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              <h2>
                <AccordionButton>
                  <Box flex="1" textAlign="left">
                    <Heading as="h2" size="sm">
                      Why might the media want to follow-up with storytellers? Is MyCovidStory.ca a
                      direct line to media coverage?
                    </Heading>
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
            ...
            <AccordionItem>
              <h2>
                <AccordionButton>
                  <Box flex="1" textAlign="left">
                    <Heading as="h2" size="sm">
                      Will any companies, media, or the government be able to find out that I posted
                      this if I choose to remain anonymous?
                    </Heading>
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              ...
              <AccordionPanel pb={4}>
                ...
                identifiable information you have provided during story submission. We respect your
                choice.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                ...
                collection of Ontarians concerned by the COVID-19 response in our province and hope
                that by sharing real stories of the people impacted, decision makers at all levels
                will make the right decisions to keep Ontarians safe.
              </AccordionPanel>
            </AccordionItem>
          </Accordion>
        </Box>
