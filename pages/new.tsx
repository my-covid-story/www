...
export default function CreateStory() {
  return (
    <>
      <GlobalHead
        title="Share your COVID story | My COVID Story"
        description="We've all been affected by COVID somehow, and our stories matter. Share yours and make a difference"
      />
      <div>
