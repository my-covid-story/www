          ...
          <Accordion allowMultiple defaultIndex={[0,1,2]}>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                ...
                <p>We created My COVID Story as a way to amplify every voice that wanted to share - with government leaders, the media or the public -  regardless of whether they have their own platform or not.</p>
