...
export default function About() {
  return (
    <>
      <GlobalHead
        title="About | MyCovidStory.ca"
        description="About the group of Ontarians who believe in the power of storytelling as an effective means of driving governement action"
      />
      <div>
        <Box w="95%" p={8} pb={24}>
          <Box pb={4}>
          ...
          <Box pb={7}>
            ...
            <Text>
              ...
              means to drive government action.
            </Text>
          </Box>
          <Box pb={7}>
            <Heading as="h2" size="l" pb={4}>
            ...
            <Text>
              To amplify the stories of anyone impacted by COVID-19 and use the power of
              storytelling to drive effective government policy that will save lives.
            </Text>
          </Box>
          <Box pb={7}>
            <Heading as="h2" size="l" pb={4}>
            ...
            <Stack spacing={4}>
              <Text>
                ...
                Data might be easy to dismiss but stories, and the human connection they spark,
                cannot be ignored.
              </Text>
              <Text>
                Many doctors, business owners, essential workers and concerned Ontarians have
              ...
              <Text>
                ...
                decision-makers to drive effective government policy and the adoption of
                science-based practices that will save lives.
              </Text>
            </Stack>
          </Box>
          <Box>
